...
/**
 *  @defgroup CONTACT
 *  @brief Functions to contact the Device Manager.
 */

/**
 * @brief  Ask the device to contact the server immediately.
 *
 * @ingroup CONTACT
 *
...
/**
 *  @defgroup CONTAINERS
 *  @brief Functions to get informations about containers
 */
 ...
 * @ingroup CONTAINERS
 *
 * @return The number of container slots in the system.
 *
 * @details
 *
...
/**
 * @brief  Write the container update policy.
 *
 * @ingroup CONTAINERS
 *
...
/**
 * @brief Reserve a GPIO and configure it for input.
 *
 * @ingroup GPIO
 *
...
/**
 * @brief Configure a GPIO for output and set its initial value.
 *
 * @ingroup GPIO
 *
 * @param id      The name of the GPIO.
...
/**
 * @brief Release a GPIO that you don't use anymore.
 *
 * @ingroup GPIO
 *
 * @param id    The id of the GPIO.
...
/**
 * @brief Write a value on a GPIO configured in output.
 *
 * @ingroup GPIO
 *
 * @param id      The id of the GPIO.
...
/**
 * @defgroup REBOOT
 * @brief    These functions are related to system restart.
 *
 */
...
/**
 * @brief  Check if a reboot is currently pending.
 *
 * @ingroup REBOOT
 *
...
/**
 * @brief  Enable or cancel a pending reboot.
 *
 * @ingroup REBOOT
 *
...
/**
 * @brief Get the name of the recipe used to build a package.
 *
 * @ingroup SBOM
 *
 * @param name      The name of the package extracted from the result of `eris_list_packages`.
 * @param buffer    The buffer to fill with the recipe name.
 * @param size      The size of the buffer.
 *
 * @return 0 on success, -1 on error and errno is set appropriately.
 *
 * @details
 *
 * This function fills the buffer with the name of the recipe used to
 * build the package.
 *
...
/**
 * @brief  Get the current update status of the system.
 *
 * @ingroup SYSTEM
 *
 ...
 * reboot the system.
 *
 * This is very useful on embedded systems to avoid devices that stay in an
